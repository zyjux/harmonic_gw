...
for time in tqdm(ds.time):
    ...
    sav_fn = "E:/research_data/2022_harmonic_gravity_waves/preprocessed_images/full_ims/" + re.sub(":", "-", str(time.values)[:-10]) + "_" + str(ds.satellite.sel(time=time).values) + "_log_image.png"
